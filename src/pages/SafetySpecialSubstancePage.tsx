...
export function SafetySpecialSubstancePage() {
  ...
  return (
    <Layout>
      <section aria-labelledby="safety-special-substance-page-title" className="w-full">
        <h1 id="safety-special-substance-page-title" className="text-2xl font-bold text-gray-900">
          {PAGE_TITLES['/safety/special-substance']}
        </h1>
