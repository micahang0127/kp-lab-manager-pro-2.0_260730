...
import { RegisterAccountCheckPage } from '../pages/RegisterAccountCheckPage'
...
export const Route = createFileRoute('/register-account-check')({
  beforeLoad: () => {
  ...
  component: RegisterAccountCheckPage,
})
